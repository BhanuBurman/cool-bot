...
def main():
    ...
    #
    #     try:
    #         route = router_func(query)
    #         if route == "document_qa":
    #             # RetrievalQA expects a string query, no chat history
    #             response = doc_chain.invoke({"query": query})
    #             result = response["result"]
    #             # Append user and bot messages to history
